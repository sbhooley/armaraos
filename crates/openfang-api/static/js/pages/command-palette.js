...
var CMD_PALETTE_PAGES = [
  ...
  { label: 'Graph Memory', sublabel: 'AINL graph force view (episodes, facts, persona)', hash: 'graph-memory',
    icon: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="5" r="2"/><circle cx="5" cy="19" r="2"/><circle cx="19" cy="19" r="2"/><line x1="12" y1="7" x2="5" y2="17"/><line x1="12" y1="7" x2="19" y2="17"/><line x1="7" y1="19" x2="17" y2="19"/></svg>' },
  { label: 'Trajectories', sublabel: 'ainl_trajectories, detail JSON, trajectory SSE', hash: 'trajectories',
    icon: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19h16"/><path d="M7 17V9"/><path d="M12 17V5"/><path d="M17 17v-6"/></svg>' },
  { label: 'Learning failures', sublabel: 'Typed failure nodes, search, FailureLearned SSE', hash: 'graph-failures',
    icon: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 9v4"/><path d="M12 17h.01"/><circle cx="12" cy="12" r="10"/></svg>' },
  { label: 'Improvement proposals', sublabel: 'Ledger + ImprovementProposalAdopted SSE', hash: 'graph-proposals',
    icon: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l8 4.5v9L12 21l-8-4.5v-9L12 3z"/><path d="M12 12l8-4.5M12 12v9M12 12L4 7.5"/></svg>' },
  { label: 'Orchestration traces', sublabel: 'Delegation graph, Gantt, filters, quota bars', hash: 'orchestration-traces',
    icon: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 2v4M12 18v4M2 12h4M18 12h4"/><circle cx="12" cy="12" r="9"/></svg>' },
  ...
  { label: 'Skills/MCP', sublabel: 'ClawHub skills, MCP servers, presets', hash: 'skills',
  ...
  { label: 'Premium', sublabel: 'Premium autonomous capability packages', hash: 'hands',
    icon: '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 2 2.9 6 6.6.6-5 4.4 1.5 6.5L12 16l-6 3.5 1.5-6.5-5-4.4 6.6-.6z"/></svg>' },
