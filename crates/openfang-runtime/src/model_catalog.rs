    ...
    pub fn default_model_for_provider(&self, provider: &str) -> Option<String> {
        ...
        if provider == "standardcompute" {
            ...
            return self
                ...
                .iter()
                .find(|m| {
                    m.provider == "standardcompute" && m.id == DEFAULT_STANDARDCOMPUTE_MODEL_ID
                })
                .map(|m| m.id.clone());
        }
...
fn builtin_models() -> Vec<ModelCatalogEntry> {
    vec![
        ...
        ModelCatalogEntry {
            id: "openrouter/minimax/minimax-m2.5:free".into(),
            display_name: "MiniMax M2.5 (OpenRouter, free)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Smart,
            context_window: 200_000,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "openrouter/google/veo-3.1".into(),
            display_name: "Google Veo 3.1 (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            context_window: 32_768,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "openrouter/bytedance/seedance-1-5-pro".into(),
            display_name: "ByteDance Seedance 1.5 Pro (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            context_window: 32_768,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            id: "openrouter/alibaba/wan-2.6".into(),
            display_name: "Alibaba Wan 2.6 (OpenRouter)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Frontier,
            context_window: 32_768,
            max_output_tokens: 8_192,
        ...
        ModelCatalogEntry {
            ...
            display_name: "Z.AI GLM 4.5 Air (OpenRouter, free)".into(),
            provider: "openrouter".into(),
            tier: ModelTier::Balanced,
            context_window: 131_072,
            max_output_tokens: 8_192,
