...
If you discover a security vulnerability in ArmaraOS, please report it responsibly.
...
ArmaraOS implements defense-in-depth with the following security controls:
