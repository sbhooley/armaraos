...
|-----------|---------|------------------|
| **Stable** (no semver pre-release segment) | `v0.6.3` | Replaces the whole `public/downloads/armaraos/` tree (except `README.md`), writes **`latest.json`** and **`beta.json`** (same manifest until you split feeds). |
